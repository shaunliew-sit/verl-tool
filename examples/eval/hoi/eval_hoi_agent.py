...
def extract_action_from_response(response: str) -> str:
    ...
    # Comprehensive list including HICO and SWIG action verbs
    common_verbs = [
        # Original HICO common verbs
        'riding', 'sitting', 'holding', 'walking', 'carrying', 'wearing', 
        ...
        # Additional HICO verbs
        'straddling', 'jumping', 'inspecting', 'watching', 'wielding', 'opening',
        'flying', 'racing', 'rowing', 'hugging', 'running', 'boarding', 'flipping',
        'picking', 'kissing', 'kicking', 'hitting', 'swinging', 'feeding', 'typing',
        'texting', 'talking', 'surfing', 'skiing', 'skating', 'snowboarding',
        # SWIG action verbs (comprehensive list)
        'adjusting', 'admiring', 'aiming', 'applauding', 'applying', 'apprehending',
        'arching', 'arranging', 'arresting', 'asking', 'assembling', 'attaching',
        'attacking', 'autographing', 'baking', 'bandaging', 'baptizing', 'barbecuing',
        'bathing', 'begging', 'biting', 'blocking', 'bothering', 'bouncing', 'braiding',
        'breaking', 'brewing', 'browsing', 'brushing', 'buckling', 'building',
        'bulldozing', 'burning', 'burying', 'buttering', 'butting', 'buttoning',
        'buying', 'calling', 'calming', 'camping', 'caressing', 'carting', 'carving',
        'chasing', 'checking', 'chewing', 'chiseling', 'chopping', 'circling',
        'clapping', 'clawing', 'clearing', 'clenching', 'climbing', 'clinging',
        'clipping', 'coaching', 'coloring', 'combing', 'communicating', 'commuting',
        'competing', 'complaining', 'confronting', 'constructing', 'cooking',
        'counting', 'covering', 'crafting', 'cramming', 'crashing', 'crowning',
        'crushing', 'curling', 'decorating', 'deflecting', 'descending', 'destroying',
        'detaining', 'dialing', 'dining', 'dipping', 'disciplining', 'disembarking',
        'displaying', 'dissecting', 'distracting', 'distributing', 'docking', 'dousing',
        'dragging', 'drawing', 'drenching', 'dripping', 'dropping', 'drumming',
        'drying', 'ducking', 'dusting', 'dyeing', 'educating', 'ejecting', 'embracing',
        'emerging', 'emptying', 'encouraging', 'erasing', 'examining', 'exercising',
        'exterminating', 'extinguishing', 'falling', 'farming', 'fastening', 'fetching',
        'filling', 'filming', 'fishing', 'flexing', 'flicking', 'flinging', 'floating',
        'flossing', 'folding', 'foraging', 'fording', 'frisking', 'frying', 'fueling',
        'gambling', 'gardening', 'giggling', 'giving', 'glaring', 'gluing', 'gnawing',
        'grilling', 'grimacing', 'grinding', 'guarding', 'handcuffing', 'hanging',
        'harvesting', 'heaving', 'helping', 'hoisting', 'hunching', 'hunting', 'hurling',
        'igniting', 'ignoring', 'imitating', 'immersing', 'inflating', 'injecting',
        'inserting', 'installing', 'instructing', 'interrogating', 'interviewing',
        'juggling', 'kneading', 'kneeling', 'knocking', 'lacing', 'lathering',
        'launching', 'leading', 'leaning', 'leaping', 'lecturing', 'licking', 'lifting',
        'lighting', 'loading', 'locking', 'making', 'manicuring', 'mashing', 'massaging',
        'measuring', 'mending', 'microwaving', 'milking', 'mining', 'moistening',
        'moisturizing', 'molding', 'mopping', 'mowing', 'nagging', 'nailing', 'nipping',
        'nuzzling', 'offering', 'packaging', 'packing', 'painting', 'panhandling',
        'parachuting', 'pasting', 'patting', 'paying', 'pedaling', 'peeing', 'peeling',
        'performing', 'phoning', 'photographing', 'piloting', 'pinching', 'pinning',
        'pitching', 'placing', 'planting', 'plowing', 'plummeting', 'plunging', 'poking',
        'pooing', 'potting', 'pouncing', 'pouring', 'practicing', 'preaching', 'pressing',
        'pricking', 'providing', 'pruning', 'prying', 'puckering', 'pumping', 'punching',
        'punting', 'putting', 'raking', 'ramming', 'reassuring', 'recovering',
        'rehabilitating', 'releasing', 'resting', 'restraining', 'retrieving', 'rinsing',
        'rocking', 'rubbing', 'saluting', 'saying', 'scolding', 'scooping', 'scraping',
        'scratching', 'scrubbing', 'sealing', 'selling', 'serving', 'sewing', 'shaking',
        'sharpening', 'shaving', 'shearing', 'shelling', 'shelving', 'shooting',
        'shopping', 'shouting', 'shoveling', 'shredding', 'shushing', 'signaling',
        'signing', 'skipping', 'slapping', 'slicing', 'sliding', 'slipping', 'slouching',
        'smashing', 'smearing', 'smelling', 'sniffing', 'snuggling', 'soaking',
        'socializing', 'sowing', 'spanking', 'speaking', 'spearing', 'spilling',
        'spinning', 'spitting', 'splashing', 'spraying', 'spreading', 'sprinkling',
        'spying', 'squeezing', 'squinting', 'stacking', 'stapling', 'staring', 'steering',
        'stirring', 'stitching', 'strapping', 'stretching', 'striking', 'stripping',
        'stroking', 'stuffing', 'stumbling', 'subduing', 'submerging', 'sucking',
        'sweeping', 'tackling', 'taping', 'tasting', 'tattooing', 'teaching', 'tearing',
        'tickling', 'tilling', 'tilting', 'tipping', 'training', 'trimming', 'tripping',
        'tugging', 'tuning', 'turning', 'twirling', 'twisting', 'tying', 'uncorking',
        'unloading', 'unlocking', 'unpacking', 'unplugging', 'unveiling', 'urinating',
        'vacuuming', 'vaulting', 'videotaping', 'wading', 'wagging', 'watering', 'waving',
        'waxing', 'weeding', 'weighing', 'welding', 'wetting', 'wheeling', 'whipping',
        'whisking', 'whistling', 'winking', 'wiping', 'working', 'wrapping', 'wringing',
        'writing', 'yanking',
        # Additional missing verbs from SWIG and HICO
        'pooing', 'sketching', 'blowing', 'controlling', 'directing', 'dribbling',
        'exiting', 'flushing', 'greeting', 'grooming', 'herding', 'hopping', 'hosing',
        'lassoing', 'losing', 'moving', 'parking', 'petting', 'pointing', 'sailing',
        'setting', 'sipping', 'strolling', 'toasting',
        'tossing', 'touching', 'transporting', 'wrecking', 'zipping',
        # Additional HICO verbs
        'stabbing', 'sticking', 'stopping', 'tagging'
    ]
