#!/bin/bash
# Run HICO Referring Evaluation with HOI Agent
#
# Prerequisites:
...
#   OUTPUT_DIR      - Output directory (default: results/hico_referring_agent)
...
WANDB="${WANDB:-false}"
OUTPUT_DIR="${OUTPUT_DIR:-results/hico_referring_agent}"
...
LOG_FILE="${LOG_DIR}/eval-hico-referring-${TIMESTAMP}.log"
